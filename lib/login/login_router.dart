...
import 'page/wechat_login_page.dart';
...
class LoginRouter implements IRouterProvider{
  ...
  static String weChatLoginPage='/login/weChatLogin';
  ...
  void initRouter(FluroRouter router) {
    ...
    router.define(weChatLoginPage, handler: Handler(handlerFunc: (_, __) => const WeChatLoginPage()));
  }
